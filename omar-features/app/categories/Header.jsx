...
const Header = () => {
  ...
  return (
 <header className="relative w-full min-h-[60vh] flex flex-col items-center justify-center overflow-hidden font-['Poppins'] bg-[#E0F7FA] px-4 sm:px-8 md:px-12 py-16">
  <AnimatedBackground />
  ...
  >
    <div className="w-full max-w-4xl p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl">
      <motion.p
        ...
        className="text-2xl sm:text-4xl md:text-5xl font-extrabold leading-snug text-gray-800 flex flex-col items-center justify-center"
      >
        <span className="whitespace-nowrap text-balance px-2">
          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              {["MANAGE", "EDIT", "ADD", "DELETE"][currentWordIndex % 4]}
            </motion.span>
          </AnimatePresence>
        </span>
